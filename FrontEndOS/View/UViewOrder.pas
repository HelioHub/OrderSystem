...
type
  TFViewOrder = class(TForm)
    ...
    procedure cxGridOrdersFocusedViewChanged(Sender: TcxCustomGrid;
...
procedure TFViewOrder.cxGridOrdersFocusedViewChanged(Sender: TcxCustomGrid;
  APrevFocusedView, AFocusedView: TcxCustomGridView);
begin
{
  Try
