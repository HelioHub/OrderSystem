object FViewOrder: TFViewOrder
  ...
  object cxGridOrders: TcxGrid
    ...
    ParentFont = False
    TabOrder = 1
    OnFocusedViewChanged = cxGridOrdersFocusedViewChanged
  ...
  object cxGrid1: TcxGrid
    ...
    object cxGridDBTableView1: TcxGridDBTableView
      ...
      Navigator.InfoPanel.Visible = True
      Navigator.Visible = True
      DataController.DataSource = DSOrderItems
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <>
      DataController.Summary.SummaryGroups = <>
      FilterRow.ApplyChanges = fracImmediately
  ...
  object DSOrders: TDataSource
    AutoEdit = False
    DataSet = DMConnection.MemTableOrders
    Left = 328
    Top = 160
  end
  ...
  object DSOrderItems: TDataSource
    AutoEdit = False
    DataSet = DMConnection.MemTableOrders_Items
    Left = 320
    Top = 368
  end
end
